...
current official `i2i`, `t2i`, `t2v`, `r2v`, `rv2v_case1`, `v2v_case1`, `mv2v`, and `ads2v` at mid
profile; use the
[official public parity bundle](../bernini-r-1.3b-2026-08-11/README.md) for committed full prompts
and contact sheets, and the
