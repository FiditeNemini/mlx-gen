...
| [ADR 0007](0007_role_aware_reference_conditioning_and_factored_model_sources.md) | Accepted | Reference images are typed conditioning, and factored model components require explicit compatible sources and provenance. |
