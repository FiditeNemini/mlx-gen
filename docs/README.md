...
- [Bernini-R 1.3B](bernini.md): experimental reference-to-video and video-edit routes, pinned factored BF16 setup, measured memory, and the schema-v3 proof showing passing machine contracts but a failed visual release gate.
