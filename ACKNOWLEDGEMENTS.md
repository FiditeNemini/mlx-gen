...
MLX-Gen also depends on the work of the MLX, Hugging Face, Black Forest Labs, Qwen, Bria, Tongyi, Baidu, Prism ML, ByteDance, Depth Pro, and broader open-source model communities. Model-specific licenses and attribution remain governed by the original model repositories.
