...
- [Quantization](quantization.md): current q4/q8 behavior, including the Qwen mixed q4/q8 policy and ERNIE q8/q4 validation.
...
- [Troubleshooting](troubleshooting.md): common missing-artifact, cache, local-path, ERNIE Prompt Enhancer, and small-resolution ERNIE issues.
